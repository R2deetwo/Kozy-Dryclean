...
const SIZES = {
  sm: { height: 28, text: 'text-base', subtitle: 'text-[8px]', gap: 'gap-2' },
  md: { height: 36, text: 'text-xl', subtitle: 'text-[9px]', gap: 'gap-2.5' },
  lg: { height: 48, text: 'text-2xl', subtitle: 'text-[10px]', gap: 'gap-3' },
}
