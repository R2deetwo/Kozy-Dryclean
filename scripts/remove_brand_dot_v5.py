...
X0, X1, Y0, Y1 = 442, 496, 690, 731   # y 690..730 inclusive
reg = a[Y0:Y1, X0:X1]
...
Image.fromarray(res).save(f'{OUT}/carrier-k-final-nodot6.png')
print('saved carrier-k-final-nodot6.png')
...
z1.save(f'{OUT}/nodot6-zoom-stem-4x.png')
z2 = Image.fromarray(res).crop((400, 450, 700, 760)).resize((900, 930), Image.LANCZOS)
z2.save(f'{OUT}/nodot6-zoom-fullK-3x.png')
