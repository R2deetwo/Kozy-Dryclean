// AFTER screenshots of the redesigned croquis figures
...
(async () => {
  ...
  for (const tab of ['men', 'women', 'children']) {
    try {
      ...
      if (svg) {
        await svg.screenshot({ path: `/home/z/my-project/work/croquis/after-${tab}-fig.png` });
        console.log(`ok: after-${tab}-fig.png`);
      }
      await page.screenshot({ path: `/home/z/my-project/work/croquis/after-${tab}-panel.png` });
      console.log(`ok: after-${tab}-panel.png`);
    ...
    try {
      ...
      if (svg2) {
        await svg2.screenshot({ path: `/home/z/my-project/work/croquis/after-${tab}-active.png` });
        console.log(`ok: after-${tab}-active.png`);
      }
